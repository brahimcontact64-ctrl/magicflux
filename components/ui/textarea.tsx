...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, ...props }, ref) => {
    return (
      <textarea
        className={cn(
          // Phase 9.4.2: text-base (16px) below `md`, text-sm (14px) at/above
          // it -- iOS Safari auto-zooms the page on focus when a text input's
          // computed font-size is under 16px. Desktop keeps the original size.
