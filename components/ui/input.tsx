  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          // Phase 9.4.2: text-base (16px) below `md` to avoid iOS Safari's
          // auto-zoom-on-focus for inputs under 16px; text-sm (14px) at/above
          // `md` keeps the original desktop size.
