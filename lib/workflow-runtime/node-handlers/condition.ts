...
import { asRecord, getNestedValue, resolveFieldReference } from './json-field-reference';
...
// resolveFieldReference() is now imported from ./json-field-reference --
// shared with email.ts (Phase 9.8.7) so both handlers recognize the exact
// same narrow `={{$json["field"]}}` shape and cannot drift apart.
